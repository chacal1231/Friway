...
<?php $this->start('west'); ?>
	<div class="box2 filter_block">
		...
		<ul class="list2 menu-list" id="browse">
			...
			<?php if (!empty($uid)): ?>
                        <li><a class="json-view" data-url="<?php echo $this->request->base?>/blogs/browse/my" href="<?php echo $this->request->base?>/blogs/browse/my"><?php echo __('My Entries')?></a></li>
			<li><a class="json-view" data-url="<?php echo $this->request->base?>/blogs/browse/friends" href="<?php echo $this->request->base?>/blogs/browse/friends"><?php echo __("Friends' Entries")?></a></li>
                        <?php endif; ?>
		</ul>

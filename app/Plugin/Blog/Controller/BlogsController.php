...
class BlogsController extends BlogAppController {
    ...
    public function beforeMooViewRender($event) {
        $allowActions = array('index');
        if(in_array($this->params['action'],$allowActions)){
...
/*
    ...
    public function view($id = null)
	{
        ...
        $this->set('description_for_layout', String::truncate(strip_tags($blog['Blog']['body']), 160, array('ellipsis' => '...', 'html' => false, 'exact' => false)));
    ...
    public function _checkPrivacy($privacy, $owner, $arefriends)
    {

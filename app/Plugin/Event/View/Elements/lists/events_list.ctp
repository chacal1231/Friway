                        ...
                        <div class="dropdown">
                            ...
                            <ul role="menu" class="dropdown-menu" aria-labelledby="dropdown-edit" style="float: right;">
                                ...
                                <?php if ( ($event['Event']['user_id'] == $uid ) || ( !empty( $event['Event']['id'] ) && !empty($cuser) && $cuser['Role']['is_admin'] ) ): ?>
                                    <li style="border-top:none"><a href="javascript:void(0)" onclick="mooConfirm( '<?php echo addslashes(__( 'Are you sure you want to remove this event?'))?>', '<?php echo $this->request->base?>/events/do_delete/<?php echo $event['Event']['id']?>' )"> <?php echo __( 'Delete Event')?></a></li>

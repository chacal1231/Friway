...
class VideosController extends VideoAppController
{
	...
	********************/
	...
	public function view( $id = null )
	{
        ...
        $this->set('description_for_layout', String::truncate(strip_tags($video['Video']['description']), 160, array('ellipsis' => '...', 'exact' => false)));
    ...
    public function categories_list(){
        if($this->request->is('requested')){
            ...
            $categories = $this->Category->getCategories( 'Video');
            return $categories;
        }
    }
}

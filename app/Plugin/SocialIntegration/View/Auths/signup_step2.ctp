...
jQuery(document).ready(function(){
    ...
    jQuery("#step2Submit").click(function(){
        if($('#tos').is(':checked')){
            ...
            jQuery.post("<?php echo $this->request->base?>/social/auths/ajax_signup_step2/<?php echo $provider ?>", jQuery("#regForm").serialize(), function(data){
                $('#step2Box').spin(false);
                var result = '';
                try
                {
            ...
            jQuery("#regError").fadeIn();
            jQuery("#regError").html('You have to agree with term of service');
        }
    });
});
            ...
            <div class="box51">
                <form id="regForm" class="form-horizontal" >
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-md-9 ">
                            <?php echo $this->Form->select('gender', array('Male' => __('Male'), 'Female' => __('Female')), array('value' => 'Male'),array('class'=>'form-control')); ?>
                        </div>
                    </div>
                    ...
                    <label for="timezone" class="col-md-3 control-label"></label>
                    <div class="col-md-9 ">
                        <?php echo $this->Form->input('tos',array('type' =>'checkbox','hiddenField' => false,'label' => __('I have read and agree to the ').$this->Html->link(__('term of service.'),array('plugin' => false, 'controller' => 'pages', 'action' => 'term-of-service')) ) ); ?>
                    </div>
                    </div>

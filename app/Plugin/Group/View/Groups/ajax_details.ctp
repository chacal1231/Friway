...
<ul class="list6 info">
	...
	<li><label><?php echo __('Description:');?></label><div><?php echo nl2br($this->Text->convert_clickable_links_for_hashtags($group['Group']['description'], Configure::read('Group.group_hashtag_enabled')))?></div></li>
	<?php endif; ?>
</ul>

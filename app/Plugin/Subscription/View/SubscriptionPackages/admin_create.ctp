                                    ...
                                    <div id="all-pricing-plan" style="overflow: hidden">
                                        <div class="pricing-plan">
                                            ...
                                            <div class="form-group pricing-plan-select">
                                                ...
                                                <div class="col-md-2">
                                                    <?php
                                                    $planOption = array(SUBSCRIPTION_ONE_TIME=> __('One Time'),SUBSCRIPTION_RECURRING => __('Recurring'), SUBSCRIPTION_TRIAL_RECURRING => __('Trail + Recurring'), SUBSCRIPTION_TRIAL_ONE_TIME => __('Trail + One Time') );
...
<?php $this->Html->scriptStart(array('inline' => false)); ?>
    ...
    {
        $.post(baseUrl+'/admin/subscription/subscription_packages/pricing_plan',null, function(response){
            try
            {
                ...
                window.values = $('#SubscriptionPackageAdminCreateForm').serialize();
            }
            catch(err)
            {
                json = '';
    ...
    function load_pricing_plan(div,value)
    {
        var plan_detail;
    ...
    function load_edit_pricing_plan()
    {
        ...
        for(var i = 0; i < count_plan; i++ )
        {
            ...
            load_pricing_plan(div,parseInt(pricingPlan[i].type));
	...
	window.onbeforeunload = function(e) {	
		var checked = false;
		var values = $('#SubscriptionPackageAdminCreateForm').serialize();

                ...
                <div class="field-css-classes description description-thin">
                    <label for="edit-menu-item-classes-<?php echo  $item['CoreMenuItem']['id'] ?>">
                        ...
                        <div><input type="text" id="edit-menu-item-classes-<?php echo  $item['CoreMenuItem']['id'] ?>"
                            ...
                            <div>
                            <span class="more-des"><?php echo __('Enter class of Font Awesome icon to use. <a target="_blank" href="http://fortawesome.github.io/Font-Awesome/icons/">Click</a> to visit the site. You can use your own icons by overriding the css in your theme stylesheet');?></span>
                            </div>
                        </div>
                    </label>
                ...
                <div class="field-css-classes description description-thin">
                    <label for="edit-menu-item-classes-<?php echo  $item['CoreMenuItem']['id'] ?>">
                        ...
                        <input type="text" id="edit-menu-item-classes-<?php echo  $item['CoreMenuItem']['id'] ?>"
                               ...
                               name="menu-item-classes[<?php echo  $item['CoreMenuItem']['id'] ?>]" value=""/>
                             <div>
                            <span><?php echo __('Enter class of Font Awesome icon to use. <a target="_blank" href="http://fortawesome.github.io/Font-Awesome/icons/">Click</a> to visit the site. You can use your own icons by overriding the css in your theme stylesheet');?></span>
                                </div>
                        </div>
                    </label>
            ...
            <div class="field-css-classes description description-thin">
                <label for="edit-menu-item-classes-<?php echo  $item['CoreMenuItem']['id'] ?>">
                    ...
                    <input type="text" id="edit-menu-item-classes-<?php echo  $item['CoreMenuItem']['id'] ?>"
                           ...
                           name="menu-item-classes[<?php echo  $item['CoreMenuItem']['id'] ?>]" value=""/>
                    <div>
                        <span class="more-des"><?php echo __('Enter class of Font Awesome icon to use. <a target="_blank" href="http://fortawesome.github.io/Font-Awesome/icons/">Click</a> to visit the site. You can use your own icons by overriding the css in your theme stylesheet</span>');?></div>
                    </div>
                </label>

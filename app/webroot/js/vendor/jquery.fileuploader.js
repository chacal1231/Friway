...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            uploadButton: mooPhraseVars['fineupload_uploadbutton'],
            cancelButton: mooPhraseVars['fineupload_cancel'],
            retryButton: mooPhraseVars['fineupload_retry'],
            failUpload: mooPhraseVars['fineupload_failupload'],
            dragZone: mooPhraseVars['fineupload_dragzone'],
            dropProcessing: mooPhraseVars['fineupload_dropprocessing'],
            formatProgress: mooPhraseVars['fineupload_formatprogress'],
            waitingForResponse: mooPhraseVars['fineupload_waitingforresponse']
        },

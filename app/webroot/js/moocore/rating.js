(function (root, factory) {
        if (typeof define === 'function' && define.amd) {
            ...
            root.mooRating = factory(root.jQuery);
        }
    }(this, function ($) {
    var allow_re_rating = 0;
    function init(allow_re_rating){
        if(typeof allow_re_rating !== 'undefined' && allow_re_rating == 1)
        {
            setAllowReRating();
            jQuery('body').on('mouseenter','div[id^="stars_"]',function(e){
            ...
            jQuery('body').on('click','div[id^="stars_"]',function(e){
                //var offset = $(this).offset();
                //e.pageX - offset.left;
                ...
                $.post(baseUrl+'/ratings/do_rate',{params:$(this).attr('id'),score:score,uid:uid},function(data){
                    var result;
                    try {

...
<?php if ( $page == 1 ): ?>
    <?php !empty($dislike)? $text = __n("%s People Dislike This","%s Peoples Dislike This", count($users),count($users)) : $text = __n("%s People Like This","%s Peoples Like This", count($users),count($users)); ?>

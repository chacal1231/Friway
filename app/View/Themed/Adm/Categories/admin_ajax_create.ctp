...
<?php echo $this->Form->hidden('id', array('value' => $category['Category']['id'])); ?>
 ...
 ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <?php
                    $options = array('class'=>'form-control','value' => $category['Category']['type']);
                    echo $this->Form->select('type', array( 'Photo' => 'Album',
                        APP_EVENT => 'Event',
                        APP_GROUP => 'Group',
                        APP_TOPIC => 'Topic',
                        APP_VIDEO => 'Video'
        ...
        <?php
         else:  echo $this->Form->hidden('type',array('value' => $type));
         endif; ?>
        <div class="form-group">

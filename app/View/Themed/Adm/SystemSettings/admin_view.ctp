...
<?php endif; ?>
<?php if(Configure::read('core.production_mode') == 1):?>
                                ...
                                ?>
                                    ...
                                    <?php if($setting['name'] == 'logo'):?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <img src="<?php echo $this->request->webroot . $setting['value_actual']?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"><?php echo __('Remove Logo');?></label>
                                            <div class="col-md-7">

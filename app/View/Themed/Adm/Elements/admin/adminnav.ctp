    ...
    <ul class="sub-menu">
        ...
        <?php if ( $cuser['Role']['is_super'] ): ?>
            ...
            <li <?php if ($cmenu == 'profile_fields') echo 'class="active"'; ?>>
                <a href="<?php echo $this->request->base?>/admin/profile_fields"><i class="spicon-check"></i> <?php echo  __('Profile Fields');?></a>
            </li>
...
<li>
 ...
 ?>
                ...
                <li <?php if ($cmenu == 'themes_editor') echo 'class="active"'; ?>>
                    <a style="margin-right:2px;" href="<?php echo $this->request->base?>/admin/themes/editor">
                        <i class="fa fa-gears"></i> <?php echo  __('Base Theme');?>
                    </a>
                </li>
            </ul>
        </li>

...
echo $this->Html->script(array('moophrase.js'), array('inline' => false));
...
<?php $this->Html->scriptStart(array('inline' => false)); ?>
                ...
                MooPhrase.add("edit_page_info", '<?php echo __('Edit Page Info.');?>');
                    ...
                    <div class="pull-right">
                        ...
                        <div class="actions" style="float:right;position:relative">
                            <a data-close-others="true" data-hover="dropdown" data-toggle="dropdown" href="#" class="btn btn-default editing">
                                Editing <i class="fa fa-angle-down"></i>
                            </a>
...
<div id="edit-page-info" class="modal fade" title="Edit page Info">

...
class MooView extends View
{
    ...
    public $isEnableRequirejs = false;
            ...
            if($value['parent_id'] == $headerId && $value['type'] == 'widget'){
                ...
                if ($value['plugin']){
                    ...
                    echo $this->element($element,
                        array_merge($data_content,json_decode($value['params'],true)),
                        array('plugin' => $value['plugin'])
                    )
                    ;
                }else{
                    echo $this->element($element,array_merge($data_content,json_decode($value['params'],true)));
                }
            }
        }
    }
...
*/
    ...
    public function renderContent(){
        ...
        if($this->isBlocksEmtpy()) return false;
    ...
    public function renderLike()
    {
    	...
    	return $this->element('likes', array('dislikes'=>$dislikes,'like'=>$like,'likes'=>$likes,'item' => $subject[$key], 'type' => $subject[$key]['moo_type']));
    }

...
if ( !empty( $allow_upload_avatar_signup ) ): ?>
    ...
    $('.qq-upload-fail').remove();
            ...
            var uploader = new qq.FineUploader({
                ...
                request: {
                    endpoint: "<?php echo $this->request->base?>/upload/avatar_tmp"
                },
                text: {
                ...
                callbacks:{
                    ...
                    onComplete: function(id, fileName, response) {
                        $('#profile_picture_preview > img').attr('src', '<?php echo  $this->request->base ?>/uploads/tmp/'+response.filename);
...
<label for="timezone" class="col-md-3 control-label"></label>
<div class="col-md-9 ">
    <?php echo $this->Form->input('tos',array('type' =>'checkbox','hiddenField' => false,'label' => __('I have read and agree to the ').$this->Html->link(__('term of service.'),array('controller' => 'pages','term-of-service')) ) ); ?>
</div>
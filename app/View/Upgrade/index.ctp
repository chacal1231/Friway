        ...
        <div class="col-md-12">
            <div class="wrapper">
                <div id="content" class="upgrade-content">
                    ...
                    <button <?php if(!$checkPermissionGarbageFiles) echo 'disabled'; ?> id="proceed" data-href="<?php echo  $this->request->base ?>/upgrade/run" class="btn btn-danger"><?php echo __('Proceed');?>
                    </button>

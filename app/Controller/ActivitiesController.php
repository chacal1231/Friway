...
class ActivitiesController extends AppController {
    ...
    public function ajax_share() {
        ...
        if ($this->Activity->save($this->request->data)) {
            ...
            if (isset($this->request->data['video_destination']) && $this->request->data['video_destination']) {
                ...
                $params = array(
                    'title' => empty($this->request->data['title']) ? "Untitle" : $this->request->data['title'],
    ...
    public function ajax_comment()
	{
        ...
        if($isCommentOnePhoto){
            ...
            if ( $this->ActivityComment->save( $commentdata ) )
            {
                ...
                /*$users = $this->ActivityComment->find('list', array( 'conditions' => array( 'ActivityComment.activity_id' => $commentdata['activity_id'],
	...
	public function ajax_editActivity($id)
	{
        ...
        if(!empty($new_add_users)){
            ...
            $this->_sendNotificationToMentionUser($this->request->data['message'],$url,'mention_user',$new_add_users);
        }

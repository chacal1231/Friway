...
class UpgradeController extends Controller {
    ...
    public function index( $state = null )
    {
        ...
        $this->set(compact('checkPermissionGarbageFiles', 'garbageFilesDirectory'));
    ...
    public function login(){
        if(!$this->request->is('post')){
            ...
            if ( !$this->_logMeIn( $this->request->data['email'], $this->request->data['password'] ) )
            {
    ...
    private function updateShareAction(){
        ...
        /* 
         * 'blog_create', 'event_create', 'group_create', 'photos_add', 'topic_create', 
                'video_activity', 'video_create', 'wall_post', 'wall_post_link'
         */
